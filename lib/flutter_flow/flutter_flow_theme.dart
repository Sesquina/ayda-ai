...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF00A6A6);
  late Color secondary = const Color(0xFFA4C8E1);
  late Color tertiary = const Color(0xFFB2E0D4);
  ...
  late Color primaryBackground = const Color(0xFFF7FBFC);
  late Color secondaryBackground = const Color(0xFFE0F7FA);
  late Color accent1 = const Color(0xFFB2DFDB);
  late Color accent2 = const Color(0xFFFFB74D);
  late Color accent3 = const Color(0xFFFF8A65);
  late Color accent4 = const Color(0xFFB39DDB);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF1D6BB8);
  late Color secondary = const Color(0xFF4B9CD3);
  late Color tertiary = const Color(0xFF7ED1B2);
  late Color alternate = const Color(0xFFB2EBF2);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFFB0BEC5);
  late Color primaryBackground = const Color(0xFF2C3E50);
  late Color secondaryBackground = const Color(0xFF1A4D6E);
  late Color accent1 = const Color(0xFF00796B);
  late Color accent2 = const Color(0xFFFFA000);
  late Color accent3 = const Color(0xFFD84315);
  late Color accent4 = const Color(0xFF6A1B9A);
  late Color success = const Color(0xFF2E7D32);
  late Color warning = const Color(0xFFE65100);
